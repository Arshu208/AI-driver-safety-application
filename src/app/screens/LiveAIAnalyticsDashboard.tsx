import { Brain, TrendingUp, Eye, Activity, Shield } from 'lucide-react';
...
export default function LiveAIAnalyticsDashboard() {
  ...
  return (
    <div className="min-h-screen p-6 pb-24">
      <div className="mb-6">
        <h1 className="mb-2">Live AI Analytics</h1>
        <p className="text-muted-foreground text-sm">Real-time performance insights</p>
      </div>
